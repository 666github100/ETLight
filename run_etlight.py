...
def main(in_args=None):
    ...
    if in_args.hangzhou:
        ...
        memory_list =["./memory/data_hz_1.pkl","./memory/data_hz_2.pkl"]
      ...
      "anon_3_4_jinan_real_2500.json"
        ...
        memory_list =["./memory/data_jn_1.pkl","./memory/data_jn_2.pkl","./memory/data_jn_3.pkl"] 
    else:
        count = 3600
        road_net = "28_7"
        traffic_file_list = ["anon_28_7_newyork_real_double.json"]
        num_rounds = 50
        template = "real-world/newyork"
        memory_list =["./memory/data_ny_1.pkl"]
    ...
    process_list = []
    for idx,traffic_file in enumerate(traffic_file_list):
